...
Se utilizzi esclusivamente questi metodi, puoi attivarlo subito e offrire un\'esperienza d’acquisto più moderna ai tuoi clienti.<br/>
Il supporto per gli altri metodi di pagamento (es. MyBank, BancomatPay) verrà rilasciato progressivamente nelle prossime versioni.<br/><br/>
⚠️ Attivando il checkout a blocchi, verranno mostrati solo i metodi di pagamento compatibili (Carte di Credito e PayPal). Eventuali altri metodi attivi nel tuo shop non saranno visibili ai clienti fino al completamento del supporto.<br/><br/>
Se vuoi <b>disabilitare il checkout a blocchi per garantire l\'utilizzo di tutti i metodi di pagamento attivi nel tuo shop, puoi seguire la guida disponibile sulla <a href="https://doc.fabrick.it/it/plugin/woocommerce/blocks-integration/" target="_blank">documentazione ufficiale di Fabrick</a>.</b><br/>',
                'type' => 'title',
